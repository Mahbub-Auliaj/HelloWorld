...
<div class="container">
    <form action="/articles/{{$article->id}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" required="required" name="image" value="{{$article->fratured_image}}"></br>
            <img width="150px" src="{{asset('storage/'.$article->fratured_image)}}">
        </div>
